...
# find() - The find() method in Python is used to locate the index of a substring within a string. It returns the index of the first occurrence of the substring, or -1 if the substring is not found.
'''str="second a start index and third"
str2=str.find('a')
print(str2)
